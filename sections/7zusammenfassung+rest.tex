...
As described in the evaluation section, a data quality evaluation analogously to DBpedia and Zaveri's DBpedia evaluation\footnoteUrl{http://aksw.org/Projects/DBpediaDQ} needs to be conducted.
