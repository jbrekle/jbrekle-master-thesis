...
\lstdefinestyle{sparql}{numberblanklines=true, morekeywords={SELECT, WHERE, FILTER, GROUP BY, IN, AS, LIMIT, OFFSET, PREFIX, OPTIONAL, UNION}}
\lstdefinestyle{N3}{numberblanklines=true, morekeywords={foaf, prefix, rdf, skos, rdfs}}
%\usepackage{textcomp}
\lstdefinestyle{XML}
{
  morestring=[b]",
